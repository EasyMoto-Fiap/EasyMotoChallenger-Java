...
-- A ordem é a inversa da criação para respeitar as chaves estrangeiras
DELETE FROM vaga;
DELETE FROM moto;
...
-- Empresa
INSERT INTO empresa (id_empresa, nome_empresa, cnpj) VALUES
(1, 'EasyMoto S.A.', '11222333000144');

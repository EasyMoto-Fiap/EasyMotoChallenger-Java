...
('Luiz Eduardo Da Silva Pinto', '46780407062', '12981813015', 'ledu64816@gmail.com', '$2a$10$upnHeELHX/hGNZiWw3Wum.1vpq9DeIZxoafRj5kywxfzlhYG74ely', 1, 1);
...
('Bruno Alves', '84406286098', '11911111111', 'bruno.alves@email.com'),
('Carla Dias', '58556870074', '21922222222', 'carla.dias@email.com'),
('Fernando Costa', '27183062031', '11933333333', 'fernando.costa@email.com');


-- Inserir dados na tabela 'localizacao' (assumindo 0='Disponível', 1='Em Uso', 2='Manutenção')
INSERT INTO localizacao ( status_loc, data_hora, zona_virtual, latitude, longitude) VALUES
(0, '2025-09-24 10:00:00', 'Pátio SP', -23.5613, -46.6565),
(1, '2025-09-24 10:05:00', 'Zona Sul SP', -23.6000, -46.6800),
(2, '2025-09-24 10:10:00', 'Pátio RJ', -22.9068, -43.1729);
